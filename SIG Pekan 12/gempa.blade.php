...
<head>
    ...
    <body>
        <div style="text-align: center">
            <h1> Informasi Gempa Terkeni di Indonesia </h1>
        ...
        <script>
            ...
            gempas.forEach(gempa => {
                ...
                marker.bindPopup(`number: ${number}<br> Tanggal: ${gempa.Tanggal}<br> 
                Jam: ${gempa.Jam}<br> Kedalaman: ${gempa.Kedalaman}<br> Magnitude: ${gempa.Magnitude} SR<br> 
                Potensi: ${gempa.Potensi}<br> Wilayah: ${gempa.Wilayah}`).openPopup();
                number++;
            });
        </script>
    </body>
